...
void CGUIWindowSettingsScreenCalibration::ResetCalibration()
{
  ...
  pDialog->SetHeading(CVariant{31751});
...
void CGUIWindowSettingsScreenCalibration::UpdateFromControl(int iControl)
{
  ...
  if (iControl == CONTROL_PIXEL_RATIO)
  {
    ...
    if (pControl)
    {
      ...
      labelDescription = g_localizeStrings.Get(31745);
      labelValue = StringUtils::Format("{:5.3f}", info.fPixelRatio);
      labelValue = StringUtils::Format(g_localizeStrings.Get(31750), labelValue);
    }
  }
  else
  {
    ...
    if (pControl)
    {
      switch (iControl)
      {
        case CONTROL_TOP_LEFT:
        {
          ...
          labelDescription = g_localizeStrings.Get(31746);
          labelValue =
        ...
        case CONTROL_BOTTOM_RIGHT:
        {
          ...
          labelDescription = g_localizeStrings.Get(31747);
        ...
        case CONTROL_SUBTITLES:
        {
          ...
          labelDescription = g_localizeStrings.Get(31748);
          labelValue = StringUtils::Format(g_localizeStrings.Get(31750), info.iSubtitles);
        }
        break;

        case CONTROL_RESET:
        {
          labelDescription = g_localizeStrings.Get(31751);
        }
        break;
      }
    }
